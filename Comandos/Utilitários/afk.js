...
<:correct:910318012945559594> <@$authorID>, now you are afk, reason: \`$replaceText[$replaceText[$replaceText[$replaceText[$checkCondition[$message==];true;**The reason was not provided.**];false;$message];\`;];*;]\`, if you type something in the chat the afk will be disabled!
