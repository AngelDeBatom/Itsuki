...
$setGlobalUserVar[téocoins;$sum[$getGlobalUserVar[téocoins;$authorID];$getGlobalUserVar[paypal;$authorID]];$authorID]
$reply[$messageID;
...
$else
$setGlobalUserVar[téocoins;$sum[$getGlobalUserVar[téocoins;$authorID];$message];$authorID]
