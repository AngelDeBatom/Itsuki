...
{color:$getServerVar[embedscolor]}{footer:Executado por\\: $userTag:$authorAvatar};{actionRow:Level,2,1,rank1:Paypal,2,1,rank2:ZenitsuCoins,2,1,rank3:Xp,2,1,rank4};;yes]]
...
{timestamp:ms}{footer:Executado por\\: $userTag:$authorAvatar}
...
{color:$getServerVar[embedscolor]};{actionRow:Level,2,1,rank1:Paypal,2,1,rank2:ZenitsuCoins,2,1,rank3:Xp,2,1,rank4};64;7]`
}]
